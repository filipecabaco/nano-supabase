// Splinter SQL lints — pulled from https://github.com/supabase/splinter
// Source: supabase/apps/studio/lib/api/self-hosted/lints.ts
// 23 lint checks for security and performance issues
...
where
    ...
    and (
        ...
        or (
            ...
            and lower(qual) not like '%select current_setting(%)%'
        )
        or (
        ...
        or (
            ...
            and lower(with_check) not like '%select current_setting(%)%'
        )
    ))
union all
(
